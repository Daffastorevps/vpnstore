...
wget "https://github.com/Daffastorevps/vpnstore/raw/main/udp-custom-linux-amd64" -O /root/udp/udp-custom
chmod +x /root/udp/udp-custom

# Download default config
echo "Downloading default config..."
wget "https://raw.githubusercontent.com/Daffastorevps/vpnstore/main/config.json" -O /root/udp/config.json
...
mkdir -p /etc/Sslablk
cd /etc/Sslablk
wget https://github.com/Daffastorevps/vpnstore/raw/main/system.zip
unzip system.zip
